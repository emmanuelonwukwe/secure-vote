  ...
  return (
    <>
      <main>
        {/* section hero */}
        <section>
          <div className="bg-gray-100 sm:grid grid-cols-5 grid-rows-2 md:grid-rows-1 px-4 py-1 lg:min-h-screen space-y-6 sm:space-y-0 sm:gap-4">
            <div className="h-96 col-span-4 bg-gradient-to-tr from-indigo-800 to-indigo-500 rounded-md flex items-center">
              <div className="ml-20 w-80">
                ...
                <p className="text-indigo-100 mt-4 capitalize font-thin tracking-wider leading-7">
                  ...
                  <Link to="/register" className="uppercase inline-block mt-8 text-sm bg-white py-2 px-4 rounded font-semibold hover:bg-indigo-100">
                    get started
                  </Link>
              </div>
            </div>
